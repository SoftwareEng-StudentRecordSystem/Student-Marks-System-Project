...
A simple 3-table database is to used for the database implementation. The Figure below indicates the contents of each table and the interconnection among them:

\begin{center}
	\begin{figure}[h]
		\centering
		\includegraphics[scale = 0.8, width = 15cm]{Schematic.png}
		\caption{Database design of the system}
	\end{figure}
\end{center}
